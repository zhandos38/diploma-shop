  ...
  <div class="page">
    ...
    <div class="page-body">
      ...
      >
        ...
        <Column field="priceIn" header="Себестоимость без НДС" :sortable="true">
          <template #filter="{ filterModel, filterCallback }">
            <InputText
              type="text"
              v-model="filterModel.value"
        ...
        <Column field="priceRetail" header="Цена" :sortable="true">
          <template #filter="{ filterModel, filterCallback }">
            <InputText
              type="text"
              v-model="filterModel.value"
        ...
        <Column header="Наценка">
          <template #body="{ data }">
            {{ ((data.priceRetail / data.priceIn) * 100 - 100).toFixed(2) }}%
          </template>
        </Column>
...
function createButtonHandler() {
  router.push("/menu/product/form");
}

function editButtonHandler(id: number) {
  router.push({ path: "/menu/product/form", query: { id: id } });
}
